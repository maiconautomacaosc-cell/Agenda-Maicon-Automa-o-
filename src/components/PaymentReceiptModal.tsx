          ...
          <div className="bg-white text-slate-900 rounded-2xl overflow-hidden shadow-xl border border-slate-200 relative">
            ...
            <div className="p-5 sm:p-8 pl-7 sm:pl-10">
              <div className="flex justify-between gap-5 items-start border-b-2 border-slate-100 pb-5">
                <img src={logoMaicon} alt="Maicon Automação" className="w-36 sm:w-44 max-h-20 object-contain object-left-top" />
                <div className="text-right hidden sm:block"><div className="font-black text-blue-900 tracking-wide">MAICON AUTOMAÇÃO</div><div className="text-[10px] text-slate-500 mt-1">Instalação de Fechaduras Eletrônicas</div></div>
              </div>
