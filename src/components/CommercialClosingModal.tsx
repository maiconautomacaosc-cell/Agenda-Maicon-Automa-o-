  ...
  <div className="p-4 space-y-4">
   ...
   <div className="p-3 rounded-2xl bg-zinc-900 border border-zinc-800">
    ...
    <div className="mt-3 p-3 rounded-xl bg-zinc-950 border border-zinc-800 space-y-2">
      ...
      <div className="flex gap-2"><button onClick={savePayment} className="flex-1 py-2 rounded-xl bg-emerald-500 text-black font-black flex items-center justify-center gap-2">{editingPaymentId?<><Save className="w-4 h-4"/>Salvar alteração</>:<><Plus className="w-4 h-4"/>Adicionar</>}</button>{editingPaymentId&&<button onClick={clearPaymentEditor} className="px-3 py-2 rounded-xl bg-zinc-800 text-zinc-300 font-bold">Cancelar</button>}</div>
